...
PLACES = ['in the cutlery drawer', 'beneath the doormat', 'behind the clock', 'in a coat pocket', 'under the bed', 'in the breadbox', 'behind a picture frame', 'in the fruit bowl', 'inside a shoe', 'under the bathmat', 'on the highest shelf',
