...
PLACES = ['in the cutlery drawer', 'beneath the doormat', 'behind the clock', 'in a coat pocket', 'under the bed', 'in the breadbox', 'behind a picture frame', 'in the fruit bowl', 'inside a shoe', 'under the bathmat', 'on the highest shelf', 'in the biscuit tin', 'under a cushion', 'in the letterbox', 'behind the curtains', 'in the umbrella stand', 'inside a book of poems', 'in the medicine cabinet', 'in the vegetable drawer', 'under the kettle', 'in the sewing box', 'behind the mirror', 'in the laundry basket', 'in the spice rack', 'beneath the rug', 'in the fridge door', 'under the sink', 'in the sugar jar', 'in a plant pot', 'behind the radiator', 'in the toolbox', 'under the stairs', 'in the bath', 'on the windowsill', 'in the sock drawer', 'inside the piano', 'in the hall closet', 'in the recycling', 'at the bottom of the wardrobe', 'in the tea caddy', 'under the lamp', 'in the bicycle basket', 'in the glove box', 'behind the books', 'in the freezer drawer', 'in the desk drawer', 'inside the guitar', 'under the television', 'in the bread bin', 'in the ice tray', 'in the salt cellar', 'in the flour jar']
