> **Superseded.** The build task in §5 is done and the layout has moved on since this was written. The current, authoritative setup lives in `pdf/ALL-escape-room-print-me.pdf` pages 33–36 (generated by `src/build_mapping.py`). This file is kept for Ben's verbatim brief in §1.
